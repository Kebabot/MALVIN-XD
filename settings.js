...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MALVIN-XD~IgABhYpS#q1MiLuhJccCQp82vy5XiJ60-tXRDE8XdFsiQafsO5jQ",
// add your Session Id 

PREFIX: process.env.PREFIX || "#",
// add your prifix for bot

BOT_NAME: process.env.BOT_NAME || "kiba xᴅ v2",
// add bot name here for menu

CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
// make this true for custum emoji react   

STICKER_NAME: process.env.STICKER_NAME || "KIBA-XD",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "918798879524",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "✦KIBA🪀✦",
// add bot owner name

DESCRIPTION: process.env.DESCRIPTION || "> *© KIBA BOT*",
// add bot owner name    
